-- DROP
DROP TABLE IF EXISTS ROSTER SET NULL;
DROP TABLE IF EXISTS TEAM SET NULL;
DROP TABLE IF EXISTS PLAYER SET NULL;
DROP TABLE IF EXISTS TOURNAMENT SET NULL;
DROP TABLE IF EXISTS RESULT SET NULL;
DROP TABLE IF EXISTS BRACKET SET NULL;
DROP TABLE IF EXISTS PARTICIPANT SET NULL;
DROP TABLE IF EXISTS MATCH SET NULL;
DROP TABLE IF EXISTS ROLE SET NULL;
DROP TABLE IF EXISTS TALENT SET NULL;
-- CREATE
CREATE TABLE TEAM(
